...
$color_file_map = [
    // --- 判明しているもの ---
    'オリジナル' => 'original', // (JSが判定に使う特別な値)
    'ホワイト'   => '白',         // (image_cd9bdc.png から)
    'ブルー'         => '青',         // (ユーザーさんの申告から)
    'ゲーミング'  => 'ゲーミング', // (image_ce04c2.png から)
    'イエロー'   => '黄色',   // (仮) ← .../file-イエロー？ ...-yellow？ ...-黄？
    'ピンク'     => 'ピンク',     // (仮) ← .../file-ピンク？ ...-pink？
    'レッド'     => '赤',     // (仮) ← .../file-レッド？ ...-red？ ...-赤？
    'グレー'     => 'グレー',     // (仮) ← .../file-グレー？ ...-gray？ ...-灰？
    'グリーン'   => '緑'    // (仮) ← .../file-グリーン？ ...-green？ ...-緑？
];
// ▲▲▲ ここまで ▲▲▲

// カテゴリごとのカラー設定 (表示名のリスト)
$category_colors_list = [
    'C01' => ['オリジナル', 'イエロー', 'ホワイト'],
    'C02' => ['オリジナル', 'ブルー', 'グリーン'],
    'C03' => ['オリジナル', 'ブルー', 'レッド'], // 'レッド' がマップにあるのでOK
    'C04' => ['オリジナル', 'ホワイト'],
    'C05' => ['オリジナル', 'ピンク'],
    'C06' => ['オリジナル', 'グレー'],
    'C07' => ['オリジナル', 'ゲーミング'], 
